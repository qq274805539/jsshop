            ...
            <ul class="nav pull-right">
                ...
                <li class="dropdown user">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="<?php echo U('Admin/login/loginout');?>"><i class="icon-user"></i>切换用户</a></li>


                        <li><a href="<?php echo U('Admin/login/loginout');?>"><i class="icon-key"></i>退出登录</a></li>
								...
								<form action="" id="form_sample_2" method="post" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" name="type_name" data-required="1"  value="<?php echo ($type_info["type_name"]); ?>" class="span6 m-wrap"/>
									...
									<div class="form-actions">
										...
										<button type="submit" class="btn green">添加类型</button>
