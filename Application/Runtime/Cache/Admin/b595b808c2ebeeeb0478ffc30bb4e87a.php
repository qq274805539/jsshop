...
<link href="<?php echo C('ADMIN_CSS_PATH');?>jquery.gritter.css" rel="stylesheet" type="text/css"/>

<link href="<?php echo C('ADMIN_CSS_PATH');?>daterangepicker.css" rel="stylesheet" type="text/css" />

<link href="<?php echo C('ADMIN_CSS_PATH');?>fullcalendar.css" rel="stylesheet" type="text/css"/>

<link href="<?php echo C('ADMIN_CSS_PATH');?>jqvmap.css" rel="stylesheet" type="text/css" media="screen"/>

<link href="<?php echo C('ADMIN_CSS_PATH');?>jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
							...
							<div class="portlet solid bordered light-grey">
								...
								<div class="portlet-body">
									...
									<div id="site_statistics_loading">
										...
										<img src="<?php echo C('ADMIN_IMG_PATH');?>loading.gif" alt="loading" />
												...
												<div class="scroller" data-height="290px" data-always-visible="1" data-rail-visible1="1">
													...
													<div class="row-fluid">
														...
														<div class="span6 user-info">
															...
															<img alt="" src="<?php echo C('ADMIN_IMG_PATH');?>avatar.png" />
									...
									<div class="scroller" data-height="435px" data-always-visible="1" data-rail-visible1="1">
										...
										<ul class="chats">
											...
											<li class="in">
												...
												<img class="avatar" alt="" src="<?php echo C('ADMIN_IMG_PATH');?>avatar1.jpg" />
											...
											<li class="out">
												...
												<img class="avatar" alt="" src="<?php echo C('ADMIN_IMG_PATH');?>avatar2.jpg" />
											...
											<li class="out">
												...
												<img class="avatar" alt="" src="<?php echo C('ADMIN_IMG_PATH');?>avatar3.jpg" />
