							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_2" method="post" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="attribute_name" data-required="1" class="span6 m-wrap"/>
											<input type="hidden" name="type_id"  value="<?php echo ($type_id['type_id']); ?>" />
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" id="option_value"  name="attribute_option_value" data-required="1" class="span6 m-wrap"/>
										</div>
									</div>
