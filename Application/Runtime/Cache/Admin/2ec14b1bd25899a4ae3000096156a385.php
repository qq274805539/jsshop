						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">
										...
										<!--<button id="sample_editable_1_new" class="btn green">-->
											...
											<a href="<?php echo U('Admin/privilege/privilege_add');?>">添加分类 </a><i class="icon-plus"></i>
								...
								<!--<table class="table table-striped table-hover table-bordered" id="sample_editable_1">-->
                                    ...
                                    <tbody>
                                    <?php if(is_array($pri_info)): foreach($pri_info as $key=>$v): ?><tr class="">
                                            <td><?php echo ($v["id"]); ?></td>
											...
											<td><a  href="<?php echo U('Admin/Privilege/privilege_edit','',false);?>/pri_id/<?php echo ($v["id"]); ?>">修改</a></td>
