						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">
										...
										<!--<button id="sample_editable_1_new" class="btn green">-->
											...
											<a href="<?php echo U('Admin/Type/type_add');?>">添加类型 </a><i class="icon-plus"></i>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                    ...
                                    <tbody>
                                    <?php if(is_array($type_info)): foreach($type_info as $key=>$v): ?><tr class="">
                                            <td><?php echo ($v["id"]); ?></td>
                                            <td><?php echo ($v["type_name"]); ?></td>
											<td><a  href="<?php echo U('Admin/Attribute/attribute_list','',false);?>/type_id/<?php echo ($v["id"]); ?>">类型属性</a></td>
                                            <td><a  href="<?php echo U('Admin/Type/type_edit','',false);?>/id/<?php echo ($v["id"]); ?>">修改</a></td>
