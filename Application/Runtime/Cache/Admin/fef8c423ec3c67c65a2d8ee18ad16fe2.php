					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>产品展示</div>
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                    ...
                                    <tbody>
                                    <?php if(is_array($orderinfo)): foreach($orderinfo as $key=>$v): ?><tr class="">
											<td><?php echo ($v["order_id"]); ?></td>
											<td><?php echo ($v["user_id"]); ?></td>
											<td><a href="<?php echo U('order_detail','',false);?>/order_id/<?php echo ($v["order_id"]); ?>"><?php echo ($v["order_number"]); ?></a></td>
											<td><?php echo ($v["order_price"]); ?></td>
											<td><?php echo ($v["order_pay"]); ?></td>
											<td><?php echo ($v["order_id"]); ?></td>
											<td><?php echo ($v["order_fapiao_title"]); ?></td>
											<td><?php echo ($v["order_fapiao_company"]); ?></td>
											<td><?php echo ($v["cgn"]); ?></td>
											<td><?php echo ($v["order_status"]); ?></td>
											<td><?php echo (date('Y-m-d h:i:s',$v["add_time"])); ?></td>
											<td><?php echo (date('Y-m-d h:i:s',$v["upd_time"])); ?></td>
                                            <td><a  href="<?php echo U('Admin/Goods/goods_edit','',false);?>/id/<?php echo ($v["order_id"]); ?>">修改</a></td>
                                        </tr><?php endforeach; endif; ?>
									</tbody>

								</table>
								<p><a href="<?php echo U('putexcel');?>" style="font-size: 34px; line-height: 23px; color: rgb(202, 216, 219); text-align: left; text-shadow: rgba(0, 0, 0, 0) 0px 0px 0px; -webkit-text-stroke-width: 0px; opacity: 1;">导出到Excel</a> </p>
							</div>
