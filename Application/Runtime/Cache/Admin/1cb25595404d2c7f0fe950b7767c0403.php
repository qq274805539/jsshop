							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_2" method="post" class="form-horizontal" >
									...
									<div class="control-group">
										...
										<div class="controls">
											<select class="span6 m-wrap" name="parent_id">
												...
												<?php if(is_array($pri_info)): foreach($pri_info as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo str_repeat('-',$v['level']*8); echo ($v["pri_name"]); ?></option><?php endforeach; endif; ?>
											</select>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="pri_name" data-required="1" class="span6 m-wrap"/>
										</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="controller_name" data-required="1" class="span6 m-wrap"/>
										</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="model_name" data-required="1" class="span6 m-wrap"/>
										</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="action_name" data-required="1" class="span6 m-wrap"/>
