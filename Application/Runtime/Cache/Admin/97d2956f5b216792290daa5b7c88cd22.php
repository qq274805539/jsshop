							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_2" method="post" class="form-horizontal" >
									...
									<div class="control-group">
										...
										<div class="controls">
											<select class="span6 m-wrap" name="parent_id">
												...
												<?php if(is_array($cate_info)): foreach($cate_info as $key=>$v): ?><option value="<?php echo ($v["cate_id"]); ?>"><?php echo str_repeat('-',$v['level']*8); echo ($v["cate_name"]); ?></option><?php endforeach; endif; ?>
											</select>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="cate_name" data-required="1" class="span6 m-wrap"/>
										</div>

									</div>
									<div class="form-actions">
										<button type="submit" class="btn green">添加分类</button>
