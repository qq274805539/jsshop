...
<!--引入富文本编辑器-->
<script type="text/javascript" charset="utf-8" src="<?php echo C('ADMIN_PLNGIN_PATH');?>ueditor/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="<?php echo C('ADMIN_PLNGIN_PATH');?>ueditor/ueditor.all.min.js"> </script>
<script type="text/javascript" charset="utf-8" src="<?php echo C('ADMIN_PLNGIN_PATH');?>ueditor/lang/zh-cn/zh-cn.js"></script>
					...
					<div class="span12">
						...
						<div class="portlet box green">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>商品修改</div>
							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_2" method="post" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="control-group">
										...
										<div class="controls">
											<select class="span6 m-wrap" name="cate_id">
												<option value="0">--请选择--</option>
												<?php if(is_array($cate_info)): foreach($cate_info as $key=>$v): ?><option value="<?php echo ($v["cate_id"]); ?>" <?php if($v['cate_id'] == $goodsinfo['cate_id']) echo "selected='selected'" ;?> ><?php echo ($v["cate_name"]); ?></option><?php endforeach; endif; ?>
											</select>
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" name="goods_name" data-required="1" value="<?php echo ($goodsinfo["goods_name"]); ?>" class="span6 m-wrap"/>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" name="goods_price" data-required="1" value="<?php echo ($goodsinfo["goods_price"]); ?>" class="span6 m-wrap"/>
											<input type="hidden" id="g_id"  name="id" value="<?php echo ($goodsinfo["id"]); ?>"/>
										</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<button type="button" class="btn green" onclick="getupload()" >点击更换图像</button>
											<span id="gettext">&nbsp&nbsp*未填写</span>
											<input type="file" name="logo" style="display:none" id="fileupload" />
											<img src="<?php echo ($goodsinfo["logo"]); ?>"  style="width: 100px" title="没有图片"/>
										</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea name="goods_desc"   id="goods_desc" cols="10" rows="3"  style="width: 510px; height: 300px;"><?php echo ($goodsinfo["goods_desc"]); ?></textarea>
										</div>
									...
									<h3>商品图片</h3>
									<div class="controls">
										<button type="button" class="btn green" onclick="getuploads()" >上传产品图片</button>
										<span id="gettexts" style="color:red;">&nbsp&nbsp*&nbsp&nbsp按住ctrl键可以选择多张图片可以进行上传,双击图片可以进行删除以下图片</span><br/>
										<input type="file" name="goods_pic[]" style="display:none" id="fileuploads" multiple/>
										<?php if(is_array($pic)): foreach($pic as $k=>$v): ?><img src="<?php echo ($v["goods_pic"]); ?>"  style="width: 150px"  id="pics_<?php echo ($k); ?>"  ondblclick="del_pics('<?php echo ($v["goods_pic"]); ?>','<?php echo ($k); ?>')"  /><?php endforeach; endif; ?>
									</div>

									<div class="control-group">
										<label class="control-label">请选择类型<span class="required">*</span></label>
										<div class="controls">
											<select class="span6 m-wrap" name="type_id">
												<option value="">--请选择--</option>
												<?php if(is_array($type_info)): foreach($type_info as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"  <?php if($v['id'] == $goodsinfo['type_id']) echo "selected='selected'" ;?>><?php echo ($v["type_name"]); ?></option><?php endforeach; endif; ?>
											</select>
										</div>
									</div>
									...
									<div class="form-actions">
										<button type="submit" class="btn green">修改商品</button>
									</div>
...
<script type="text/javascript">
    ...
    ]] ,elementPathEnabled : false,maximumWords:1000 } )
</script>
