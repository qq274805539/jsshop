							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_2" method="post" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="control-group">
										<label class="control-label">请选择分类<span class="required">*</span></label>
										<div class="controls">
											<select class="span6 m-wrap" name="cate_id">
												<option value="">--请选择--</option>
												<?php if(is_array($cate_info)): foreach($cate_info as $key=>$v): ?><option value="<?php echo ($v["cate_id"]); ?>"><?php echo ($v["cate_name"]); ?></option><?php endforeach; endif; ?>
											</select>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea name="goods_desc"  id="goods_desc" cols="10" rows="3"  style="width: 510px; height: 300px;"></textarea>
										</div>
									...
									<div class="controls">
										...
										<span id="gettexts">&nbsp&nbsp*按住ctrl键可以选择多张图片进行上传</span>
									...
									<div class="control-group">
										...
										<div class="controls">
											<select class="span6 m-wrap" name="type_id" id="type_id">
												<option value="">--请选择--</option>
										...
										<ul  style="list-style: none" id="attribute_option">

										</ul>

									</div>
									<div class="form-actions">
										<button type="submit" class="btn green">添加商品</button>
...
<script type="text/javascript">
    ...
    //进行判断所选的的商品类别进行展示所属商品的功能
	$('#type_id').change(function(){
		var type_id= $('#type_id').val();
		//alert(type_id);
		//通过ajax获得数据
		$.getJSON("<?php echo U('Attribute/get_attribute_by_typeid');?>",{"type_id":type_id},function(data){
				//console.log(data);
            	var str='';
				$.each(data,function (n,v) {

				    //进行判断如果值是可选,拼凑出下拉框
					if(v.attribute_type =='可选'){
					    var value_option =v.attribute_option_value.split(',');
					    str+="<label class='control-label'>"+v.attribute_name+"<span class='required'>*</span></label>"
					    //console.log(value_option);
						str+="<div class='controls'>";
                        str+="<br><a href='javascript:void(0)' onclick='clone_li(this)'>[+]</a><select  name="+'attribute_option_value['+v.id+'][]'+" id ='type_id'><li>"
                        for(i=0;i<value_option.length;i++){

                            str+="<option  value="+value_option[i]+">"+value_option[i]+"</option>";
                        ...
                        //console.log(value_option);
                        str+="<div class='controls'>";
					    str+="<br><input type=text  name='attribute_option_value["+v.id+"][]'/><br>";
                        str+="</div>";
					}

                })
            $("#attribute_option").html(str);
		})
