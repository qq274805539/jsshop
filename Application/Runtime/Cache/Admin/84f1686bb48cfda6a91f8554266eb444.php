						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                    ...
                                    <tbody>
                                    <?php if(is_array($goods_info)): foreach($goods_info as $key=>$v): ?><tr class="">
                                            <td><?php echo ($v["id"]); ?></td>
                                            <td><?php echo ($v["goods_name"]); ?></td>
                                            <td><?php echo ($v["goods_price"]); ?></td>
                                            <td><?php echo ($v["cate_name"]); ?></td>
                                            <td><img src="<?php echo ($v["logo"]); ?>" style="width: 150px"></td>
                                            <td><img src="<?php echo ($v["sm_logo"]); ?>" style="width: 100px"></td>
                                            <td><?php echo (htmlspecialchars_decode($v["goods_desc"])); ?></td>
                                            <td><a  href="<?php echo U('Admin/Goods/goods_edit','',false);?>/id/<?php echo ($v["id"]); ?>">修改</a></td>
