							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_2" method="post" class="form-horizontal" >
									...
									<div class="control-group">
										...
										<div class="controls">
											<select class="span6 m-wrap" name="parent_id">
												...
												<?php if(is_array($pri_info)): foreach($pri_info as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if($v['id'] == $privilege_info['parent_id']) echo "selected='selected'" ;?>   ><?php echo str_repeat('-',$v['level']*8); echo ($v["pri_name"]); ?></option><?php endforeach; endif; ?>
											</select>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="pri_name" value="<?php echo ($privilege_info["pri_name"]); ?>" data-required="1" class="span6 m-wrap"/>
										</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="controller_name" value="<?php echo ($privilege_info["controller_name"]); ?>" data-required="1" class="span6 m-wrap"/>
										</div>

									</div>
									<div class="control-group">
										<label class="control-label">模块名称<span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="model_name" value="<?php echo ($privilege_info["model_name"]); ?>" data-required="1" class="span6 m-wrap"/>
										</div>

									</div>
									<div class="control-group">
										<label class="control-label">方法名称<span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="action_name" value="<?php echo ($privilege_info["action_name"]); ?>" ata-required="1" class="span6 m-wrap"/>
											<input type="hidden" name="id" value="<?php echo ($privilege_info["id"]); ?>"  data-required="1" class="span6 m-wrap"/>
										</div>

									</div>
									<div class="form-actions">
										<button type="submit" class="btn green">添加权限</button>
