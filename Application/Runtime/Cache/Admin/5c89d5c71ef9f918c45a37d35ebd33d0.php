					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>类型展示</div>
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">
										...
										<!--<button id="sample_editable_1_new" class="btn green">-->
											...
											<a href="<?php echo U('Admin/attribute/attribute_add','',false);?>/type_id/<?php echo ($type_id); ?>">添加属性 </a><i class="icon-plus"></i>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                    ...
                                    <tbody>
                                    <?php if(is_array($attribute_info)): foreach($attribute_info as $key=>$v): ?><tr class="">
                                            <td><?php echo ($v["id"]); ?></td>
                                            <td><?php echo ($v["attribute_name"]); ?></td>
                                            <td><?php echo ($v["attribute_type"]); ?></td>
                                            <td><?php echo ($v["attribute_—option—value"]); ?></td>
                                            <td><?php echo ($v["type_id"]); ?></td>
                                            <td><a  href="<?php echo U('Admin/attribute/attribute_edit','',false);?>/id/<?php echo ($v["id"]); ?>">修改</a></td>
