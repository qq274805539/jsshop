...
<!--引入购物车里面的需要用到的js-->
<script type="text/javascript" src="<?php echo C('HOME_JS_PATH');?>cart.js"></script>
<!-- jqzoom 效果 -->
...
<!-- 头部 end-->
			...
			<div class="related_view newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('HOME_IMG_PATH');?>relate_view1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('HOME_IMG_PATH');?>relate_view2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('HOME_IMG_PATH');?>relate_view3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('HOME_IMG_PATH');?>relate_view4.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="<?php echo C('HOME_IMG_PATH');?>relate_view5.jpg" alt="" /></a></dt>
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?php echo ($goodspic[0][big_goods_pic]); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?php echo ($goodspic[0][mid_goods_pic]); ?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								...
								<?php if(is_array($goodspic)): foreach($goodspic as $k=>$v): if(($k) == "0"): ?><li class="cur">
											<a class="zoomThumbActive" href="javascript:void(0);"
											   rel="{gallery: 'gal1', smallimage: '<?php echo ($v["mid_goods_pic"]); ?>',largeimage: '<?php echo ($v["goods_pic"]); ?>"><img
													src="<?php echo ($v["sm_goods_pic"]); ?>"></a>
										</li>
										<?php else: ?>
										<li>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="market_price"><span>定价：</span><em>￥<?php echo ($goodsinfo['goods_price']+500); ?></em></li>
						<li class="shop_price"><span>本店价：</span> <strong>￥<?php echo ($goodsinfo["goods_price"]); ?></strong> <a href="">(降价通知)</a>
						</li>
						<li><span>上架时间：</span><?php echo (date('Y-m-s',$goodsinfo["add_time"])); ?></li>
					...
					<form action="" method="post" class="choose">
						<ul>
							<?php if(is_array($duo_goods_attr)): foreach($duo_goods_attr as $key=>$v): ?><li class="product">
									<dl>
										<dt><?php echo ($v["attribute_name"]); ?></dt>
										<dd>
											<?php if(is_array($v["attribute_value"])): foreach($v["attribute_value"] as $k=>$vv): if(($k) == "0"): ?><a class="selected" href="javascript:;"><?php echo ($vv); ?> <input type="radio" name="color"
																										 value="<?php echo ($vv); ?>" checked="checked"/></a>
													<?php else: ?>
							...
							<li>
								<dl>
									...
									<dd>
										...
										<input type="text" name="amount" value="1" id="buy_num"  class="amount"/>
	...
	<script type="text/javascript">
		...
		function add_cart(goods_id){
			var poxy =   getElementPos('add_btn');

			//通过ajax将值进行传递
            $.ajax({
                url:'/index.php/Home/Shop/addcart',
                data:{'goods_id':goods_id,'buy_num':$('#buy_num').val()},
                dataType:'json',
                type:'get',
                success:function (msg) {
                    ...
                    //给购物车设置位置
                    $('#cartBox').css('left',poxy.x+60);
                    $('#cartBox').css('top',poxy.y+60);
                    $('#cartBox').show();
                }
            });
				...
				<div class="detail_bd">
					<!-- 商品介绍 start -->
						...
						<div class="introduce detail_div none">
							<div class="attr mt15">
								<ul>
									<?php if(is_array($weiyi_goods_attr)): foreach($weiyi_goods_attr as $key=>$v): ?><li><span><?php echo ($v["attribute_name"]); ?>:</span><?php echo ($v["attribute_value"]); ?></li><?php endforeach; endif; ?>
						...
						<div class="desc mt10">
							...
							<img src="<?php echo C('HOME_IMG_PATH');?>desc1.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('HOME_IMG_PATH');?>desc2.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('HOME_IMG_PATH');?>desc3.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('HOME_IMG_PATH');?>desc4.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('HOME_IMG_PATH');?>desc5.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('HOME_IMG_PATH');?>desc6.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('HOME_IMG_PATH');?>desc7.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('HOME_IMG_PATH');?>desc8.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('HOME_IMG_PATH');?>desc9.jpg" alt="" />
						</div>
					</div>
					<!-- 商品介绍 end -->
					...
					<div class="comment detail_div mt10">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="<?php echo C('HOME_IMG_PATH');?>user1.gif" alt="" /></a></dt>
									<dd><a href="">乖乖</a></dd>
								</dl>
							</div>
							<div class="item">
...
<div class="buy_blank" id="cartBox" style="display:none;z-index:99;">
	<h4>
		<span><a href="javascript:;" onclick="hideElement('cartBox')"><img src="<?php echo C('HOME_IMG_PATH');?>close.jpg" title="点击关闭"/></a></span>
		该商品已成功添加到购物车
	</h4>
...
/*购物车弹出框*/
.orange{color: #CC0000;}
a.bt_orange:link,a.bt_orange:visited{color:#FFFFFF;width:107px; height:27px; line-height:27px;background:url(<?php echo C('HOME_IMG_PATH');?>chakanBtn.jpg) no-repeat; text-align:center; font-weight:bold;cursor:pointer; display:block; _display:inline; float:left; margin-left:60px;}
a.bt_blue:link,a.bt_blue:visited{color:#FFFFFF;width:107px; height:27px; line-height:27px;background:url(<?php echo C('HOME_IMG_PATH');?>tiaoxuannBtn.jpg) no-repeat; text-align:center; font-weight:bold;cursor:pointer;display:block;_display:inline; float:right; margin-right:60px;}
...
.buy_blank h4{ border-bottom:2px solid #D0D0D0; font-weight:normal; height:30px; line-height:30px;background:url(<?php echo C('HOME_IMG_PATH');?>buyicon.jpg) no-repeat 10px center; text-indent:28px; margin-bottom:10px; padding-left:20px;}
