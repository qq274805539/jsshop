			...
			<div class="goodslist mt10">
				<ul>
					<?php if(is_array($goodsinfo)): foreach($goodsinfo as $key=>$v): ?><li>
						<dl>
							<dt><a href="<?php echo U('Goods/detail','',false);?>/id/<?php echo ($v["id"]); ?>" target="_blank"><img src="<?php echo ($v["sm_logo"]); ?>" alt="" /></a></dt>
							<dd><a href="<?php echo U('Goods/detail','',false);?>/id/<?php echo ($v["id"]); ?>" target="_blank"><?php echo ($v["goods_name"]); ?></a></dt>
