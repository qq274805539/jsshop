			...
			<div class="login_form fl">
				<form action="" method="post">
					<ul>
						...
						<li>
							<label for="">手机号：</label>
							<input type="text" class="txt" id="user_tel" name="user_tel" value="17682326995" />
							<input type="button" onclick="sendCont()" value="点击获取验证码" >
							<span id="yzma"></span>
						</li>
						<li>
							<label for="">验证码：</label>
							<input type="text" class="txt"  name="user_yzm" />
						</li>
						<li>
							<label for="">邮箱：</label>
